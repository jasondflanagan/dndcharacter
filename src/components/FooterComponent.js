...
function Footer() {
        ...
        return (
            <React.Fragment>
                <footer className="site-footer" sticky="bottom" expand="md" style={{ backgroundImage: 'url(assets/wood-background.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }} >
